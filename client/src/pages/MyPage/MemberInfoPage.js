...
class MemberInfoPage extends React.Component {
  ...
  render() {
    ...
    const memberinfo = this.state.items.memberinfo.map(e => {
    return(<MemberInfo companyname={e.company_name} rank={e.rank} key={e.id}/>);
    })
                  ...
                  <Column span={4}>
                    <Box color="white" padding={1}>
                      <Box color="white" paddingX={2}>
                        ...
                        <Input name="username" name="username" id="username" value={this.state.items.memberinfo[0].username} onChange={this.textChange}/>
                      </Box>
                    </Box>
                  </Column>
                  <Column span={4}>
